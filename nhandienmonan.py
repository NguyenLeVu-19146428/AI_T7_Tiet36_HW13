...
Original file is located at
    https://colab.research.google.com/drive/1llIShvJa2TX0vU-mOgWUUfokoH9WJJDr
"""
...
label = ['Banh Chung','Banh Day','Banh Mi','Bun Dau Mam Tom','Che Buoi','Nem','Com Tam','Pho','Thit Kho Trung','Trung Vit Lon']
...
plt.title("Loai mon an duoc du doan la:  " + label[np.argmax(model.predict(x_pre_1.reshape(1,150,150,3)))])
...
plt.title("Loai mon an duoc du doan la:  " + label[np.argmax(model.predict(x_pre_3.reshape(1,150,150,3)))])
...
plt.title("Loai mon an duoc du doan la:  " + label[np.argmax(model.predict(x_pre_5.reshape(1,150,150,3)))])
...
plt.title("Loai mon an duoc du doan la:  " + label[np.argmax(model.predict(x_pre_8.reshape(1,150,150,3)))])
