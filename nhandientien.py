...
Original file is located at
    https://colab.research.google.com/drive/1X4G4FIo0M-BsHiWvGw4vBARFk9J_vUp4
"""
...
plt.title("Loai tien duoc du doan la:  " + label[np.argmax(model.predict(x_pre_7.reshape(1,150,150,3)))])
